...
;//5.0.1-v4 Sat Sep 21 12:20:27 CDT 2024
...
sg = JS.SpaceGroup.getSpaceGroupFromJmolClegOrITA(id);
...
sgname = sgname.substring(0, pt);
}}if (isInt && (itno > 230 || (isSettings || isSetting ? itno < 1 : itno < 0))) throw  new ArrayIndexOutOfBoundsException(itno);
if (isSubgroups) {
...
if (map != null) {
if (tm == null) tm = map.get("clegId");
return JS.SpaceGroup.fillMoreData(map, data, itno, its.get(0));
...
;//5.0.1-v4 Sat Sep 21 12:18:27 CDT 2024
Clazz_declarePackage("JS");
...
;//5.0.1-v4 Sat Sep 21 11:42:54 CDT 2024
Clazz_declarePackage("JS");
...
;//5.0.1-v4 Sat Sep 21 11:40:27 CDT 2024
Clazz_declarePackage("JS");
...
;//5.0.1-v4 Sat Sep 21 11:44:20 CDT 2024
Clazz_declarePackage("JS");
